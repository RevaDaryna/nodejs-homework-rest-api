...
const {TOKEN_KEY, PORT, BASE_URL} = process.env
...
const verifyCont = async (req, res) => {
...
const resendVerifyEmailCont = async(req, res) => {
...
module.exports = {
    ...
    verify: ctrlWrapper(verifyCont),
    resendVerifyEmail: ctrlWrapper(resendVerifyEmailCont)
}